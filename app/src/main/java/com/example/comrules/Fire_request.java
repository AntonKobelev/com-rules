...
public class Fire_request extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_request);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.fire_request); // проинициализируем медиаплеер
