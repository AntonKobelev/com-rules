...
public class Mayday_two extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mayday_two);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.mayday_two); // проинициализируем медиаплеер
