...
public class Executing_victims extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_executing_victims);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.executing_victims); // проинициализируем медиаплеер
