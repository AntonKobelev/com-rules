...
public class Executing_b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_executing_b);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.executing_b); // проинициализируем медиаплеер
