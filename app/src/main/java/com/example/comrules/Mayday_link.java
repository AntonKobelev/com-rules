...
public class Mayday_link extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mayday_link);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.mayday_link); // проинициализируем медиаплеер
