...
public class Order_victims extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_victims);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.order_victims); // проинициализируем медиаплеер
