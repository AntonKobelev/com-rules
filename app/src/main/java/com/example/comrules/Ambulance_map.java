...
public class Ambulance_map extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.ambulance_map); // проинициализируем медиаплеер
