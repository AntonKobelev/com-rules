...
public class Mayday_burnout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mayday_burnout);
        mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.mayday_burnout); // проинициализируем медиаплеер
